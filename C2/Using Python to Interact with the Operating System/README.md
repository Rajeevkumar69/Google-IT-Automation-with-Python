Python can be used to get the current working directory.

Python can be used to create and delete files and directories.

Python can be used to list the contents of a directory.

Python can be used to run shell commands.
